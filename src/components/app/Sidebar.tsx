...
import { Compass, FolderOpen, TrendingUp, HelpCircle, LogOut, Cog } from "lucide-react";
...
const TABS = [
  ...
  { to: "/app/services",  labelKey: "app.tab_services",   descKey: "app.desc_services",  Icon: Cog       },
